...
import { Plus, Trash2, Download, Search, Check, X, Edit, ChevronDown, RefreshCw } from 'lucide-react';
...
export function MenuTabContent({ menuItems, setMenuItems, globalSearchQuery }: MenuTabContentProps) {
  ...
  const handleBulkDelete = () => {
    ...
    if (confirm(`Apakah Anda yakin ingin menghapus ${selectedIds.length} menu terpilih?`)) {
  ...
  return (
    <div className="space-y-12 select-none font-sans pb-16 text-white text-left">
      ...
      <div className="bg-[#0F0F0F] rounded-[40px] shadow-2xl border border-white/10 overflow-hidden">
        ...
        <div className="p-6 md:p-8 border-b border-white/10 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex flex-wrap items-center gap-4">
            <h3 className="font-extrabold text-white text-lg uppercase tracking-wider">Semua Menu</h3>
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <button 
              ...
              className="bg-[#121212] hover:bg-zinc-800 text-white border border-white/20 py-2.5 px-5 rounded-full text-xs font-black uppercase tracking-wider flex items-center gap-2 transition-colors cursor-pointer"
            >
            ...
            <button 
              ...
              className="bg-zinc-900 hover:bg-zinc-800 text-red-400 border border-red-500/30 py-2.5 px-5 rounded-full text-xs font-black uppercase tracking-wider flex items-center gap-2 transition-colors cursor-pointer"
            >
            ...
            <button 
              ...
              className="bg-white hover:bg-zinc-200 text-black py-2.5 px-6 rounded-full text-xs font-black uppercase tracking-widest flex items-center gap-2 transition-transform hover:scale-[1.03] cursor-pointer"
            >
            ...
            <thead>
              <tr className="bg-[#121212] border-b-2 border-white/10 text-xs font-black text-zinc-400 uppercase tracking-widest">
                <th className="py-4 px-6 w-12 text-center">
                  <input
                    type="checkbox"
                    checked={allFiltered.length > 0 && allFiltered.every(i => selectedIds.includes(i.id))}
                    onChange={() => toggleSelectAll(allFiltered)}
                    className="rounded border-zinc-700 bg-zinc-950 text-white focus:ring-0 cursor-pointer"
                  />
                </th>
                <th 
                ...
                >
                  ID MENU 
                  <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-200 ${sortAsc ? 'rotate-180' : ''}`} />
                </th>
              ...
              {allFiltered.length === 0 ? (
                ...
                allFiltered.map((item) => (
                  <tr key={item.id} className="hover:bg-white/5 transition-colors">
                    ...
                    {editingId === item.id ? (
                      <>
                        <td className="py-3 px-6 font-mono text-xs text-zinc-500 font-bold">{item.id}</td>
                        <td className="py-3 px-6">
                          <input
                            type="text"
                            value={editName}
                            onChange={(e) => setEditName(e.target.value)}
                            className="bg-[#0A0A0A] border-2 border-zinc-800 text-white rounded font-bold px-3 py-1.5 text-sm w-36 outline-none focus:border-white transition-colors"
                          />
                        </td>
                        <td className="py-3 px-6">
                          <input
                            ...
                            className="bg-[#0A0A0A] border-2 border-zinc-800 text-white rounded font-mono font-bold px-3 py-1.5 text-sm w-24 outline-none focus:border-white transition-colors"
                          />
                        </td>
                        <td className="py-3 px-6">
                          <input
                            ...
                            className="bg-[#0A0A0A] border-2 border-zinc-800 text-white rounded font-mono font-bold px-3 py-1.5 text-sm w-16 outline-none focus:border-white transition-colors"
                          />
                        </td>
                        <td className="py-3 px-6">
                          <input
                            ...
                            className="bg-[#0A0A0A] border-2 border-zinc-800 text-white rounded font-bold px-3 py-1.5 text-sm w-full outline-none focus:border-white transition-colors"
                          />
                        </td>
                        <td className="py-3 px-6 text-center flex items-center justify-center gap-1.5">
                          ...
                          <button
                            ...
                            className="p-1.5 px-3 text-xs bg-zinc-850 hover:bg-zinc-800 text-zinc-300 rounded font-bold flex items-center gap-1 cursor-pointer transition-transform hover:scale-105"
                          >
                            <X size={12} />
                          </button>
                        </td>
                      ...
                      <>
                        <td className="py-4 px-6 font-mono text-xs text-zinc-500 font-bold">{item.id.toUpperCase()}</td>
                        <td className="py-4 px-6 font-extrabold text-white text-md uppercase tracking-tight">{item.name}</td>
                        ...
                        <td className="py-4 px-6 text-xs text-zinc-405 truncate max-w-xs font-semibold" title={item.description}>
                          {item.description}
                        </td>
                        <td className="py-4 px-6 text-center flex items-center justify-center gap-3">
                          ...
                          <button
                            ...
                            className="text-zinc-400 hover:text-red-450 p-1.5 rounded transition-colors cursor-pointer"
                            title="Hapus"
                          >
                            <Trash2 size={14} />
                          </button>
        ...
        <div className="p-4 border-t border-white/10 flex items-center justify-center gap-1.5 text-zinc-500 text-xs">
          {[1, 2, 3, '...', 8, 9, 10].map((num, idx) => (
            <button
              ...
              className={`w-7 h-7 hover:bg-zinc-800 flex items-center justify-center border font-bold transition-all ${
                pageAll === num
      ...
      <div className="bg-[#0F0F0F] rounded-[40px] shadow-2xl border border-white/10 overflow-hidden">
        ...
        <div className="p-6 md:p-8 border-b border-white/10 flex items-center justify-between">
          <div className="flex flex-wrap items-center gap-4">
            <h3 className="font-extrabold text-white text-lg uppercase tracking-wider">Menu Tersedia</h3>
            <div className="relative">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-zinc-500 w-4 h-4" />
              <input
                type="text"
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#121212] border-b-2 border-white/10 text-xs font-black text-zinc-300 uppercase tracking-widest">
                <th className="py-4 px-6 font-mono text-xs w-1/4">ID MENU</th>
            ...
            <tbody className="divide-y divide-white/5 text-sm">
              {availableFiltered.length === 0 ? (
                <tr>
                  <td colSpan={5} className="py-12 text-center text-zinc-500 font-bold uppercase tracking-wider">
                ...
                availableFiltered.map((item) => (
                  <tr key={item.id} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="py-4 px-6 font-mono text-xs text-zinc-300 font-bold">{item.stock} PCS</td>
                    <td className="py-4 px-6 text-xs text-zinc-405 truncate max-w-xs font-semibold">
                      {item.description}
                    </td>
                  </tr>
                ))
      ...
      <div className="bg-[#0F0F0F] rounded-[40px] shadow-2xl border border-white/10 overflow-hidden">
        ...
        <div className="p-6 md:p-8 border-b border-white/10 flex items-center justify-between">
          <div className="flex flex-wrap items-center gap-4">
            <h3 className="font-extrabold text-white text-lg uppercase tracking-wider">Menu Tidak Tersedia</h3>
            <div className="relative">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-zinc-500 w-4 h-4" />
              <input
                type="text"
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#121212] border-b-2 border-white/10 text-xs font-black text-zinc-350 uppercase tracking-widest">
                <th className="py-4 px-6 font-mono text-xs w-1/4">ID MENU</th>
                <th className="py-4 px-6 font-black w-1/4">NAMA MENU</th>
                <th className="py-4 px-6 font-black w-1/6">HARGA MENU</th>
                <th className="py-4 px-5 w-1/12">STOK MENU</th>
                <th className="py-4 px-6 font-black w-1/4">DESKRIPSI MENU</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/5 text-sm">
              {unavailableFiltered.length === 0 ? (
                <tr>
                  <td colSpan={5} className="py-12 text-center text-zinc-650 font-bold uppercase tracking-wider">
                    Menu Tidak Tersedia
                  </td>
                </tr>
              ) : (
                unavailableFiltered.map((item) => (
                  <tr key={item.id} className="hover:bg-white/5 transition-colors text-zinc-500">
                    <td className="py-4 px-6 font-mono text-xs text-zinc-650 font-bold">{item.id.toUpperCase()}</td>
                    <td className="py-4 px-6 font-extrabold text-zinc-550 text-md uppercase tracking-tight line-through">{item.name}</td>
                    <td className="py-4 px-6 font-mono text-xs text-zinc-550">
                      {formatRupiah(item.price)}
                    </td>
                    <td className="py-4 px-5 font-mono text-xs text-zinc-550">{item.stock} PCS</td>
      ...
      {isAddOpen && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-55 animate-in fade-in duration-200">
          <div className="bg-white text-black rounded-[40px] border-b-4 border-r-4 border-black w-full max-w-md p-8 shadow-2xl relative">
            ...
            <h3 className="text-3xl font-display font-black tracking-tight uppercase mb-6 leading-none pt-2">TAMBAH MENU.</h3>
            
            <form onSubmit={handleAddMenu} className="space-y-6 text-left">
              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 block mb-1">Nama Menu</label>
                <input
                  type="text"
                  required
                  value={newName}
              ...
              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 block mb-1">Harga Menu (Rupiah)</label>
                <input
                  type="number"
                  required
                  value={newPrice}
              ...
              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 block mb-1">Stok Awal</label>
                <input
                  type="number"
                  required
                  value={newStock}
              ...
              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 block mb-1">Deskripsi Menu</label>
                <textarea
                  rows={2}
                  value={newDesc}
              ...
              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 block mb-2">Status Ketersediaan</label>
                <div className="flex gap-4">
                  <button
                    ...
                    className={`flex-1 py-3 px-4 rounded-full text-xs font-black uppercase tracking-widest transition-transform hover:scale-105 cursor-pointer ${
                      newIsAvailable ? 'bg-black text-white' : 'bg-zinc-100 text-zinc-400'
                    }`}
                  >
                    Tersedia
                  </button>
