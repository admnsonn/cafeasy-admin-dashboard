...
export function Sidebar({
  ...
  return (
    <aside className="w-72 bg-[#1F2937] text-zinc-100 flex flex-col justify-between h-screen sticky top-0 border-r border-white/10 select-none flex-shrink-0 font-sans">
