...
export function ProfileTabContent({
  ...
  const [editSection, setEditSection] = useState<
    "profile" | "pribadi" | "professional" | null
  >(null);
  ...
  const startEditSection = (
    section: "profile" | "pribadi" | "professional",
  ) => {
  ...
  const handleTriggerAvatarChange = () => {
    ...
    const picked =
      freshAvatars[Math.floor(Math.random() * freshAvatars.length)];
    ...
    <div className="space-y-8 select-none font-sans pb-16 text-white text-left">
      ...
      <div>
        ...
        <p className="text-xs text-[#333333] font-bold uppercase tracking-wider mt-1">
          Konfigurasi Hak Akses & Parameter Cafe
        </p>
      </div>

      <div className="bg-[#FFFFFF] rounded-[40px] shadow-2xl border border-white/10 overflow-hidden">
        ...
        {/* Profile Details Bar */}
        <div className="p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 relative border-b border-[#E6E6E6]">
          <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
            ...
            <div className="relative -mt-16 md:-mt-20">
              <img
                src={
                  profile.avatarUrl ||
                  "https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=150&auto=format&fit=facearea&facepad=2"
                }
            ...
            <div>
              <h3 className="text-2xl font-black font-display text-[#333333] flex items-center gap-3 uppercase tracking-tight">
                {profile.firstName} {profile.lastName}
              </h3>
              <p className="text-xs text-[#333333] font-mono mt-1 font-bold tracking-wider">
                {profile.email.toUpperCase()}
              </p>
              <p className="text-xs text-[#333333] font-mono mt-1 max-w-md line-clamp-1">
        ...
        <div className="p-6 md:p-8 space-y-8 bg-white">
          ...
          <div className="bg-white rounded-3xl border-1 border-[#E6E6E6] p-6 md:p-8 shadow-md">
            <div className="flex items-center justify-between mb-6 pb-4 border-b border-[#E6E6E6]">
              <h4 className="font-black text-[#333333] text-xs uppercase tracking-widest flex items-center gap-2">
              ...
              {editSection === "pribadi" || editSection === "profile" ? null : (
                <button
                  ...
                  className="flex items-center gap-1 text-[10px] font-black uppercase tracking-widest text-[#333333] hover:text-[#333333] bg-white py-1.5 px-3.5 rounded-full transition-colors cursor-pointer border-1 border-[#E6E6E6]"
                >
                  <Edit3 className="w-3" />
                  Edit
                </button>
            ...
            {editSection === "pribadi" || editSection === "profile" ? (
              <form onSubmit={handleSavePribadi} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-[10px] font-black uppercase tracking-widest text-[#333333] mb-2">
                      Nama Cafe
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full py-2 pr-10 text-md font-medium outline-none placeholder:text-zinc-200 transition-colors bg-[#FFFFFF] rounded-lg text-[#333333] px-3 border-1 border-[#E6E6E6]"
                    />
                  </div>
                  <div>
                    <label className="block text-[10px] font-black uppercase tracking-widest text-[#333333] mb-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                <div>
                  <span className="block text-[10px] font-black uppercase tracking-widest text-[#333333] mb-2">
                    Nama Cafe
                  </span>
                  <div className="w-full py-2 pr-10 text-md font-medium outline-none placeholder:text-zinc-200 transition-colors bg-[#FFFFFF] rounded-lg text-[#333333] px-3 border-1 border-[#E6E6E6]">
                    {profile.cafeName}
                  </div>
                </div>
                <div>
