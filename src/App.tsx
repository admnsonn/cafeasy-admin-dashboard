...
export default function App() {
  ...
  const [currentView, setCurrentView] = useState<ApplicationView>(
    ApplicationView.SPLASH,
  );
  const [activeTab, setActiveTab] = useState<DashboardTab>(
    DashboardTab.DATA_MENU,
  );
  ...
  const [menuItems, setMenuItems] = useState<MenuItem[]>([
    {
      ...
      stock: 20,
      description:
        "Lechy Ice adalan es leci segar premium dengan buah leci pilihan.",
      isAvailable: true,
    },
    {
      id: "menu-j8g3l4",
      ...
      stock: 15,
      description:
        "Nasi Gila ini adalan tumisan sosis bakso pedas gila gurih di atas nasi hangat.",
      isAvailable: true,
    },
    {
      id: "menu-rmg68k",
      ...
      stock: 30,
      description:
        "Bebek Goreng garing di luar, empuk gurih di dalam dilumuri bumbu rahasia.",
      isAvailable: true,
    },
    {
      id: "menu-vrfigq",
      ...
      stock: 17,
      description:
        "Nasi Goreng tradisional spesial bumbu rempah harum nusantara.",
      isAvailable: true,
    },
  ]);
  ...
  const [categories, setCategories] = useState<Category[]>([
    {
      ...
      name: "Sajian Utama",
      description:
        "Nasi gila, nasi goreng, bebek goreng manis, serta sup tradisional.",
    },
    {
      id: "cat-02",
      name: "Minuman Segar",
      description:
        "Aneka jus, Lechy Ice soda gergaji, boba, matcha, iced americano.",
    },
    {
      id: "cat-03",
      name: "Camilan Gurih",
      description:
        "Kentang goreng bumbu bawang, mendoan crispy, singkong keju.",
    },
  ]);
  ...
  const [banners, setBanners] = useState<BannerItem[]>([
    ...
    },
    {
      id: "ban-002",
      title:
        "Sarapan Sehat Hemat: Dapatkan Nasi Goreng + Kopi Susu Aren hanya Rp.25rb",
      imageUrl:
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case DashboardTab.PROFILE_ADMIN:
        return <ProfileTabContent profile={profile} setProfile={setProfile} />;
