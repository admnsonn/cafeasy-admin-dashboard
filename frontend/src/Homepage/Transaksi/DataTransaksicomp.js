      ...
      <div className="py-4">
        <div className="p-6 bg-white rounded-lg border border-gray-200">
          <div className="flex flex-wrap justify-between items-center gap-4 mb-6">
            <div>
              <div className="text-2xl font-black text-gray-900 tracking-wider">Datatable Transaksi</div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mb-8 w-full bg-white border border-gray-200 rounded-lg shadow-lg p-5">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-5">
                <div className="text-base font-bold text-gray-900">Semua Transaksi</div>
